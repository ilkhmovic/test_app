...
urlpatterns = [
    ...
    path('test/<int:test_id>/', views.ready_to_test, name='ready_to_test'),
    path('test/<int:test_id>/start/', views.test, name='test'),
    ...
    path('add-question-field/', views.add_question_field, name='add_question_field'),
    path('my-tests/', views.my_tests, name='my_tests'),
    path('test/<int:test_id>/manage/', views.test_detail, name='test_detail'),
